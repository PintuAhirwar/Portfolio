		...
		<>
			...
			<section className="section-hero-1 position-relative pt-120 pb-120 overflow-hidden">
				<div className="container position-relative z-3">
					<div className="row">
						<div className="col-lg-6 col-md-12">
							<span className="text-dark">👋 Hi there, I'm Pintu</span>
							<h1 className="ds-2 mb-3">Full Stack Developer & <span className="text-primary-1">Creative Designer</span></h1>
							<p className="text-300 mb-6">BCA Student at Renaissance University, Indore. I build real-world web apps using Django & Next.js,
								and bring 3+ years of Graphic Design experience — from branding to digital creatives.</p>
							<Link href="/assets/resume_pintu_ahirwar.pdf" className="btn btn-gradient me-2" target="_blank">
								Download CV
							...
							<p className="text-400 mt-6 mb-3">Dev Stack & Design Stack</p>
				...
				<div className="shape-1 position-absolute bottom-0 start-50 z-1 ms-10 d-none d-md-block">
					<img className="position-relative z-1" src="/assets/imgs/hero/hero-1/man.png" alt="man" />
